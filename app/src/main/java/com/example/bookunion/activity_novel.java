...
public class activity_novel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_novel_activity);

        recyclerView = findViewById(R.id.recyclerView_nov);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Novel_Books");
        ...
        adapter = new FirebaseRecyclerAdapter<DataSetFireBook, FirebaseViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull FirebaseViewHolder holder, int position, @NonNull final DataSetFireBook model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(activity_novel.this, activity_book_details.class);
            ...
            public FirebaseViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
                return new FirebaseViewHolder(LayoutInflater.from(activity_novel.this).inflate(R.layout.row, viewGroup, false));
            }
        };
